...
//debuge($update_sql);
    ...
    function wp_admin_bar_bookings_menu(){
        ...
        else if ($curr_user_role == 'supervisor')     $level = 1;
        ...
        $wp_admin_bar->add_menu(
         ...
         else if ($curr_user_role_settings == 'supervisor')     $level = 1;
...
function wpbc_is_current_user_have_this_role( $user_role ) {
   ...
   if ( $user_role == 'supervisor')      $user_role = 'manage_leaves';
