...
//BUG ? : WPBC_LOCALE_RELOAD  not set correctly when search-results appear on a new page
//if (WPBC_LOCALE_RELOAD == 'WPBC_LOCALE_RELOAD')    define( 'WPBC_LOCALE_RELOAD', get_locale() );
