...
*/
            ...
            ?> <script type="text/javascript">
								swal({title:'Okie dokie!', text:'Your request has been cancelled and your supervisor has been notified.', type:'success'}, function(){window.location.href = '<?php echo get_permalink($post->post_parent); ?>/leave';});
                ...
                setTimeout( function () { location.href = '<?php echo get_permalink($post->post_parent); ?>/leave'; }, parseInt( 1000 + new_booking_title_time ) );  //FixIn: 8.3.3.13
               </script>
            <?php
            die();
        }
                        ...
                        if ($my_booking_id_type !== false) {
                            ...
                            if (isset($_GET['booking_cancel'])) {
                                ...
                                // $html .= $wpbc_nonce . '<input type="button" value="' . $value . '"' . $atts . ' onclick="bookingCancelByVisitor(\''.$_GET['booking_hash'].'\','.$this->current_booking_type.', \''.wpbc_get_booking_locale().'\' );" />';
																...
																$html .= 'function confirmCancel(e) {';
																$html .= 'swal({';
																$html .= 'title: "Are you sure?",';
																$html .= 'text: "This request will be sent to your supervisor, you\'ll be notified once it gets approved.",';
																$html .= 'type: "warning",';
																$html .= 'showCancelButton: true,';
																$html .= 'confirmButtonColor: "#DD6B55",';
																$html .= 'confirmButtonText: "Yes, cancel!",';
																$html .= 'closeOnConfirm: false,';
																$html .= '},';
																$html .= 'function(isConfirm){';
																$html .= 'if (isConfirm){';
																$html .= 'bookingCancelByVisitor(\''.$_GET['booking_hash'].'\','.$this->current_booking_type.', \''.wpbc_get_booking_locale().'\' );';
																$html .= '}});}';
																$html .= '</script>';
																$html .= $wpbc_nonce;
																$html .= '<div class="deg-btn" style="margin-top:30px;"><div class="deg-btn-wrapper waves-effect waves-red waves-light"> <button type="button" onclick="confirmCancel(this);">Cancel booking</button></div></div>';
                            	...
                            	$atts = ' class="' . trim($class_att) . '" style="font-weight:600;" ';
										...
										$html .= 'showCancelButton: true,';
										$html .= 'confirmButtonColor: "#DD6B55",';
										$html .= 'confirmButtonText: "Yes, submit!",';
										$html .= 'closeOnConfirm: false,';
										$html .= '},';
										$html .= 'function(isConfirm){';
										$html .= 'if (isConfirm){';
										$html .= 'mybooking_submit(e.form,'.$this->current_booking_type.', \''.wpbc_get_booking_locale().'\' );';
										$html .= 'swal.close();';
										$html .= '}});}';
										$html .= '</script>';
										$html .= '<div class="deg-btn" style="margin-top:30px;"><div class="deg-btn-wrapper waves-effect waves-red waves-light"> <button type="button" onclick="confirmSubmit(this);">' . $value . '</button></div></div>';
