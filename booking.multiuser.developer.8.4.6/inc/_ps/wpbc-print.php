              ...
              <table style="width:100%;" >
                  ...
                  <tbody>
                      ...
                      <tr id="wpbc_print_row<?php echo $print_item[0]; ?>" class="wpbc_print_rows booking-listing-row wpbc-listing-row <?php if ($is_alternative_color) echo ' row_alternative_color ';?>" >
                          ...
                          <td class=" bktextcenter"><?php echo '<span class="label label-default" style="padding: 0 !important;">' . $print_item[1][1] . '</span><br><span class="label label-default" style="padding: 0 !important;"><b>Status:</b>'.$print_item[1][0].'</span>'; ?></td>
