        ...
        function applyCSStoDays(date ){
            ...
            if ( ( false ) && ( date.getDate() == (wpdev_bk_today[2] )  ) && ( date.getMonth() == (wpdev_bk_today[1]-1)  ) &&( date.getFullYear() == (wpdev_bk_today[0])  ) ){
				...
				if ( my_test_date2.getTime() < my_test_date1.getTime() )
					return [ false, 'cal4date-' + class_day];
			}
            ...
            if (typeof( is_this_day_available ) == 'function') {
                ...
                if (! is_day_available) {return [false, 'cal4date-' + class_day + season_filter ];}
            }
            ...
            for (var i=0; i<user_unavilable_days.length;i++) {
                if (date.getDay()==user_unavilable_days[i])   return [false, 'cal4date-' + class_day ];
            }
    ...
    if (document.getElementById('calendar_booking'+bk_type) === null )  {
        ...
        if ( (! is_pay_now) || ( is_booking_without_payment == true ) )
            if (type_of_thank_you_message == 'page') {      // Page
                ...
                document.getElementById('submiting'+bk_type).innerHTML = '<p>'+new_booking_title+'</p>';
        ...
        if ( location.href.indexOf('admin.php') == -1 ) {                       // Front End
            ...
            if ((!is_pay_now) || (is_booking_without_payment == true)) {
                if (type_of_thank_you_message == 'page') {      // Page
                    ...
                    swal({title: "Good job!", text: new_booking_title, type: "success"}, function(){
...
// console.log( '|id, type, val, visible|::', jQuery( el ).attr( 'name' ), '|' + jQuery( el ).attr( 'type' ) + '|', jQuery( el ).val(), jQuery( el ).is( ':visible' ) );
                ...
                Materialize.toast('\''+el.placeholder+'\''+ ' is a required field.', 5000);
								is_error_in_field = false;    // Error
							}
						}
					}
